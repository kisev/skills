---
description: Подтверждённо включить scheduled task definition.
---

# /schedule-enable

Загрузи skill `schedule` через native Skill tool и следуй ему как authoritative. Выполни только режим `enable`.
