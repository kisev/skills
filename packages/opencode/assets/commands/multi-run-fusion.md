---
description: Подготовить и подтвердить новую fusion attempt.
---

# /multi-run-fusion

Загрузи skill `multi-run` через native Skill tool и следуй ему как authoritative. Выполни только режим `fusion`.
