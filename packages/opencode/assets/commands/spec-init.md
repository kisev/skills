---
description: Создать первую canonical specification нового проекта.
---

# /spec-init

Загрузи skill `project-spec` через native Skill tool и следуй ему как authoritative. Выполни только режим `spec-init`.
