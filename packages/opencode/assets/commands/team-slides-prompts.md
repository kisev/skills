---
description: Подготовить prompts для слайдов командного цикла.
---

# /team-slides-prompts

Загрузи skill `team-workflow` через native Skill tool и следуй ему как authoritative. Выполни только режим `slides-prompts`.
