---
description: Подготовить предложение scope следующего командного цикла.
---

# /team-planning

Загрузи skill `team-workflow` через native Skill tool и следуй ему как authoritative. Выполни только режим `planning`.
