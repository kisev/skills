...
function commandHelp(
  ...
  return [
    `agentomatic ${CATALOG.version} - ${topic}`,
    "",
    summary,
    "",
    "Usage:",
...
function contextualHelp(arguments_: readonly string[]): string | undefined {
  ...
  if (domain === "doctor")
    return commandHelp(
      ...
      ["agentomatic doctor [--global] [--json]"],
      [
  ...
  if (domain === "agent" && operation === "list")
    return commandHelp(
      ...
      ["agentomatic agent list [--global] [--json]"],
      [
        ["--global", "Inspect global scope; project scope is the default."],
  ...
  if (domain === "agent")
    return groupHelp(
      ...
      "agentomatic agent <command> [options]",
      [
  ...
  if (domain === "critic")
    return groupHelp(
      ...
      "agentomatic critic <command> [options]",
      [
