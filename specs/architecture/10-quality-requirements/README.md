...
Safety comes from explicit scope, archive digest verification, ownership, one-use
confirmation/receipts, secret redaction, and atomic rollback.
The normative quality requirements are in `requirements/quality/README.md`.
