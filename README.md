...
Install the exact `v2.0.4` portable release for both hosts:
...
`https://github.com/kisev/skills/tree/v2.0.4`. List its catalog without writing:
...
- Current portable release: `https://github.com/kisev/skills/tree/v2.0.4`.
