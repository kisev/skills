...
3. Prepare and validate the complete `specs/` file set, then create all 19 files with rollback if any write fails.
...
4. After the interview, create only canonical `specs/` and necessary ADRs, using atomic replacement or rollback for the complete file set.
