...
2. Use the language of the latest user request, defaulting to English when ambiguous, and preserve the project and ongoing conversation style unless they conflict with an explicit request.
