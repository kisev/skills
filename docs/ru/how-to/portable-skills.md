...
Установка пакета не устанавливает и не обновляет переносимые навыки. После
подтверждения `reconcile` может архивировать помеченный устаревший навык и
напрямую вызвать точную версию `skills` для очистки OpenCode и Codex. Откат
охватывает пути из preview; конкурентные незапланированные изменения защищаются
в режиме best-effort. Навыки без маркера и неизвестные навыки удаляются вручную.
Конфликты, рабочие деревья и состояние выполнения сохраняются.
