...
один `--global` выбирает глобальное состояние. Инструменты пакета используют тот
же project default. Очистка переносимых навыков проверяет закреплённый внешний CLI
