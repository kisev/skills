...
- [Get started with portable skills](tutorials/getting-started.md) - install the
  stable distribution for Codex and OpenCode and verify the result.
...
- [Architecture](architecture.md) - source-of-truth boundaries, build and
  distribution, host integration, runtime behavior, and invariants.
- [Canonical specification](../specs/README.md) - normative requirements,
  architecture decisions, and capability contracts for maintainers.
